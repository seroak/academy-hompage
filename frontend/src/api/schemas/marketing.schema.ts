...
export const MarketingDashboardSchema = z.object({
  ...
  creatives: z.array(MarketingMetricsSchema.extend({ campaignId: z.string(), campaignName: z.string(), adId: z.string(), adName: z.string(), imageUrl: z.string().nullable(), thumbnailUrl: z.string().nullable() })),
