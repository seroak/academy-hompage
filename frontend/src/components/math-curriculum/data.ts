...
export const programs: MathProgram[] = [
  ...
  },
  {
    ...
    lessons: ['블록, 카드, 만들기, 스티커 활동', '오감 활동으로 수학을 즐겁게 경험', '이야기 흐름으로 원리를 자연스럽게 이해'],
  ...
  },
  {
    ...
    lessons: ['교구 활동과 원리 이해를 함께 설계', '사고력 문제 풀이로 해결 전략 연습', '교과 연계로 학교 수학까지 연결'],
...
export const recommendations = [
  { title: '만들고 조작하는 활동을 좋아하는 아이', description: '게임과 교구로 개념을 즐겁게 이해해요.', program: '플레이팩토', tone: 'orange' as const, imageSrc: '/images/math/playfacto-activity.png' },
  { title: '수학이 처음이거나 흥미가 필요한 아이', description: '놀이를 통해 수학을 즐겁게 시작해요.', program: '요리수 수학', tone: 'mint' as const, imageSrc: '/images/math/yorisu-activity.png' },
  { title: '학교 수학도 함께 잘하고 싶은 아이', description: '사고력과 교과를 함께 강화해요.', program: '씨투엠(C2M)', tone: 'blue' as const, imageSrc: '/images/math/c2m-activity.png' },
]

export const toneClasses: Record<ProgramTone, { badge: string; text: string; surface: string; border: string; fill: string }> = {
  orange: { badge: 'bg-[#fff0df] text-[#e86f00]', text: 'text-[#e86f00]', surface: 'bg-[#fff8f1]', border: 'border-[#ffc887]', fill: 'bg-[#ff8a1f]' },
  mint: { badge: 'bg-[#e8f8ed] text-[#27834a]', text: 'text-[#27834a]', surface: 'bg-[#f4fbf5]', border: 'border-[#a9ddba]', fill: 'bg-[#53b875]' },
  blue: { badge: 'bg-[#eaf4ff] text-[#2875c8]', text: 'text-[#2875c8]', surface: 'bg-[#f4f9ff]', border: 'border-[#afd2f6]', fill: 'bg-[#4d98e8]' },
}
