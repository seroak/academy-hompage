    ...
    <section className="py-12 sm:py-15">
      ...
      <div className="mt-7 grid gap-3 lg:grid-cols-3">
        {recommendations.map((recommendation) => {
          ...
          return (
            <article
              key={recommendation.program}
              className={`flex min-h-[168px] flex-col rounded-[22px] border ${style.border} ${style.surface} p-5`}
            >
              <div className="grid grid-cols-[104px_1fr] gap-4">
                <div className="relative h-28 overflow-hidden rounded-[16px] bg-white">
                  <Image
                    ...
                    alt={`${recommendation.program} 추천 활동`}
                    fill
                    sizes="104px"
                ...
                <div>
                  ...
                  <h3 className="mt-2 text-base font-bold leading-5 tracking-[-0.035em] text-[#2b271f]">
      ...
      <div className="relative mt-8 overflow-hidden rounded-[24px] bg-[linear-gradient(110deg,#fff6da_0%,#ffe7a5_100%)] px-6 py-7 sm:px-8 lg:grid lg:grid-cols-[180px_1fr_auto] lg:items-center lg:gap-8 lg:px-10">
        <div className="relative hidden h-32 overflow-hidden rounded-[18px] bg-white/35 lg:block">
          <Image
            src="/images/math/consultation-still-life.png"
            alt="연필과 책이 놓인 학습 도구"
            fill
            sizes="180px"
            className="object-cover"
        ...
        <div className="relative">
          ...
          <h2 className="mt-2 text-xl font-bold tracking-[-0.045em] text-[#292317] sm:text-2xl">
            우리 아이는 어떤 과정이 맞을까요?
          </h2>
          <p className="mt-2 max-w-xl text-sm font-medium leading-6 text-[#625845]">
            전문 선생님의 1:1 상담으로 아이에게 꼭 맞는 수학 교육을 제안해드립니다.
          </p>
        </div>
